...
pub const PST: [[[i32; 64]; 9]; 2] = [
    ...
    [
        ...
        [
           ...
           0, 15, 15, 15, 14, 27, 18, 10, 4,
           15, 16, 0, 7, 21, 33, 1, -33,
           -3, -14, -21, -13, -12, -39, -21,
        ],
        // Knight
        [
        ...
        [
           -67, -23, -1, 1, 32, -44, 8, -32,
           -23, -4, 65, 49, 51, 64, 16, 13,
           -26, 39, 31, 50, 50, 87, 67, 30,
           -16, 3, 22, 37, 30, 52, 13, 1,
           -24, -11, 14, 12, 18, 6, 13, -15,
           -34, -17, 3, -3, 11, 8, 10, -24,
           -36, -34, -4, -6, 3, 14, -10, -45,
           -62, -17, -28, -8, -5, -10, -28, -24,
        ],
        // Archbishop (Bishop + Knight) - average of both
        [
          -98, -42, -58, -43, 18, -69, -4, -57,
          -49, -12, 27, 11, 26, 60, 12, -32,
          -31, 48, 40, 52, 59, 89, 55, 21,
          -6, 11, 20, 51, 37, 53, 12, 10,
          -9, 8, 14, 19, 25, 15, 15, -2,
          -17, 3, 5, 12, 16, 10, 7, -15,
          -15, -19, -16, -1, 2, 19, 9, -21,
          -69, -12, -36, -13, -15, -20, -29, -22,
        ],
...
pub const PST_ENDGAME: [[[i32; 64]; 9]; 2] = [
    ...
    [
        ...
        [
          ...
          3, 22, 24, 45, 57, 40, 57, 36, -18,
          28, 19, 47, 31, 34, 39, 23, -16,
          -27, 15, 6, 9, 17, 10, 5, -22,
          -23, -30, -16, -16, -23, -36, -32, -33,
          -28, -22, -43, -5, -32, -20, -41,
        ],
        ...
        [
          -40, -20, -5, -5, 0, -20, -10, -30,
          -15, 10, 15, 15, 20, 10, 5, -10,
          -5, 15, 25, 25, 25, 20, 10, 0,
          0, 15, 25, 30, 30, 25, 15, 5, 0,
          15, 25, 30, 30, 25, 15, 5, -5,
          10, 20, 25, 25, 20, 10, 0, -15,
          5, 10, 15, 15, 10, 0, -15, -40,
          -20, -10, -5, -5, -10, -20, -40,
        ],
    ...
    [
        ...
        3, 22, 24, 45, 57, 40, 57, 36, -20,
        6, 9, 49, 47, 35, 19, 9, -17, 20,
        32, 41, 58, 25, 30, 0, -9, 22,
        22, 27, 27, 19, 10, 20,
        ],
        // Rook (mirrored)
        [
        ...
        -15, 5, 10, 15, 15, 10, 0, -15,
        -5, 10, 20, 25, 25, 20, 10, 0,
        0, 15, 25, 30, 30, 25, 15, 5, 0,
        15, 25, 30, 30, 25, 15, 5, -5,
        15, 25, 25, 25, 20, 10, 0, -15,
        10, 15, 15, 20, 10, 5, -10, -40,
        -20, -5, -5, 0, -20, -10, -30,
        ],
        // Archbishop (mirrored)
        [
