...
pub const PST: [[[i32; 36]; 9]; 2] = [
    ...
    [
        ...
        [
            -30, -10, 0, 0, -10, -30, -10, 10, 20, 20, 10, -10, 0, 20, 30, 30, 20, 0, 0, 20, 30,
            30, 20, 0, -10, 10, 20, 20, 10, -10, -30, -10, 0, 0, -10, -30,
        ],
        // Queen (control center)
        [
            -20, -10, -5, -5, -10, -20, -10, 15, 20, 20, 15, -10, -5, 20, 25, 25, 20, -5, -5, 20,
            25, 25, 20, -5, -10, 15, 20, 20, 15, -10, -20, -10, -5, -5, -10, -20,
        ],
        // Rook (control files)
        [
            5, 10, 15, 15, 10, 5, 5, 10, 15, 15, 10, 5, 5, 10, 15, 15, 10, 5, 5, 10, 15, 15, 10, 5,
            5, 10, 15, 15, 10, 5, 5, 10, 15, 15, 10, 5,
        ],
        // Bishop (diagonal control)
        [
            0, 5, 10, 10, 5, 0, 5, 15, 20, 20, 15, 5, 10, 20, 25, 25, 20, 10, 10, 20, 25, 25, 20,
            10, 5, 15, 20, 20, 15, 5, 0, 5, 10, 10, 5, 0,
        ],
        // Knight (central outposts)
        [
            -10, -5, 0, 0, -5, -10, -5, 10, 15, 15, 10, -5, 0, 15, 20, 20, 15, 0, 0, 15, 20, 20,
            15, 0, -5, 10, 15, 15, 10, -5, -10, -5, 0, 0, -5, -10,
        ],
        // Pawn (advancement)
        [
            0, 0, 0, 0, 0, 0, 10, 15, 20, 20, 15, 10, 20, 25, 30, 30, 25, 20, 30, 35, 40, 40, 35,
            30, 40, 45, 50, 50, 45, 40, 0, 0, 0, 0, 0, 0,
        ],
        // Chancellor (Rook + Knight hybrid)
        [
            5, 10, 15, 15, 10, 5, 10, 20, 25, 25, 20, 10, 15, 25, 35, 35, 25, 15, 15, 25, 35, 35,
            25, 15, 10, 20, 25, 25, 20, 10, 5, 10, 15, 15, 10, 5,
        ],
    ...
    [
        ...
        // Pawn (advancement)
        [
            0, 0, 0, 0, 0, 0, 40, 45, 50, 50, 45, 40, 30, 35, 40, 40, 35, 30, 20, 25, 30, 30, 25,
            20, 10, 15, 20, 20, 15, 10, 0, 0, 0, 0, 0, 0,
        ],
        // Chancellor (Rook + Knight hybrid)
        [
            5, 10, 15, 15, 10, 5, 10, 20, 25, 25, 20, 10, 15, 25, 35, 35, 25, 15, 15, 25, 35, 35,
...
pub const PST_ENDGAME: [[[i32; 36]; 9]; 2] = [
    ...
    [
        ...
        [
            -10, -5, 0, 0, -5, -10, -5, 10, 15, 15, 10, -5, 0, 15, 25, 25, 15, 0, 0, 15, 25, 25,
            15, 0, -5, 10, 15, 15, 10, -5, -10, -5, 0, 0, -5, -10,
        ],
        ...
        [
            5, 10, 15, 15, 10, 5, 20, 25, 30, 30, 25, 20, 10, 15, 20, 20, 15, 10, 10, 15, 20, 20,
            15, 10, 5, 10, 15, 15, 10, 5, 0, 0, 0, 0, 0, 0,
        ],
        ...
        // Knight (central outposts)
        [
            -5, 0, 5, 5, 0, -5, 0, 10, 15, 15, 10, 0, 5, 15, 20, 20, 15, 5, 5, 15, 20, 20, 15, 5,
            0, 10, 15, 15, 10, 0, -5, 0, 5, 5, 0, -5,
        ],
        // Pawn (promotion urgency)
        [
            0, 0, 0, 0, 0, 0, 20, 25, 30, 30, 25, 20, 30, 35, 40, 40, 35, 30, 40, 45, 50, 50, 45,
            40, 50, 55, 60, 60, 55, 50, 0, 0, 0, 0, 0, 0,
        ],
    ...
    [
        ...
        // Rook (7th rank emphasis)
        [
            0, 0, 0, 0, 0, 0, 5, 10, 15, 15, 10, 5, 10, 15, 20, 20, 15, 10, 10, 15, 20, 20, 15, 10,
            20, 25, 30, 30, 25, 20, 5, 10, 15, 15, 10, 5,
        ],
        // Bishop (long diagonals)
        [
            0, 5, 10, 10, 5, 0, 5, 15, 20, 20, 15, 5, 10, 20, 25, 25, 20, 10, 10, 20, 25, 25, 20,
        ...
        // Pawn (promotion urgency)
        [
            0, 0, 0, 0, 0, 0, 50, 55, 60, 60, 55, 50, 40, 45, 50, 50, 45, 40, 30, 35, 40, 40, 35,
            30, 20, 25, 30, 30, 25, 20, 0, 0, 0, 0, 0, 0,
        ],
        // Chancellor (Rook+Knight endgame power)
        [
            5, 10, 15, 15, 10, 5, 10, 20, 25, 25, 20, 10, 15, 25, 35, 35, 25, 15, 15, 25, 35, 35,
